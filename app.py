...
with col_c:
    ...
    if not title_counts.empty:
        ...
        fig3 = px.bar(x=title_counts.values, y=title_counts.index, orientation="h",
                      ...
                      text_auto=".0f")
        fig3.update_layout(yaxis=dict(tickangle=0), height=380, margin=dict(l=10, r=10, t=40, b=10))
...
with col_d:
    ...
    if not skills_counts.empty:
        ...
        fig4 = px.bar(x=skills_counts.values, y=skills_counts.index, orientation="h",
                      ...
                      text_auto=".0f")
        fig4.update_layout(yaxis=dict(tickangle=0), height=500, margin=dict(l=10, r=10, t=40, b=10))
